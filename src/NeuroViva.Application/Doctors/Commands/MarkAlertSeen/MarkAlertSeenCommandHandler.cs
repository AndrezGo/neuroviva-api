...
public sealed class MarkAlertSeenCommandHandler : IRequestHandler<MarkAlertSeenCommand, Result>
{
    ...
    public MarkAlertSeenCommandHandler(
    ...
    public async Task<Result> Handle(MarkAlertSeenCommand request, CancellationToken cancellationToken)
    {
